...
public class UserDaoImpl extends AbstractDAO implements UserDaoInter {
    ...
    private User getUser(ResultSet rs) throws Exception {
        ...
        return new User(id, name, surname, phone, email, profileDescription, address,birthdate, nationality, birthPlace, password);
    }
    ...
    private User getUserSimple(ResultSet rs) throws Exception {
        ...
        return new User(id, name, surname, phone, email, profileDescription, address,birthdate, null, null, password);
    }
    ...
    public boolean updateUser(User u) {
        Connection con = connect();
        try {
            PreparedStatement stmt = con.prepareStatement("update user set name=?, surname=?, phone=?, email=?, password=?,profile_description=?, address=?, birthdate=?, birthplace_id=?, nationality_id=? where id = ?");
    ...
    public boolean addUser(User u) {
        Connection con = connect();
        try {
            PreparedStatement stmt = con.prepareStatement("insert into user(name, surname, phone, email, password, profile_description, address, birthdate, birthplace_id, nationality_id) values(?,?,?,?,?,?,?,?,?,?) ");
            stmt.setString(1, u.getName());
            stmt.setString(2, u.getSurname());
            stmt.setString(3, u.getPhone());
            stmt.setString(4, u.getEmail());
